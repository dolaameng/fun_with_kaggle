...
write_output(nb_bernoulli_classifier, verification_X)
print 'writing verification on naive bayesian bernoulli done...'
...
bivoting = BiVotingClassifier(svm.SVC(kernel = 'linear', C = 10, gamma = 0.01,  tol=0.0001, probability = True), # for l2 norm
...
print 'writing verification on bivoting done...'
