## model for contract_type - very useful for prediction of salary, but with a lot of missing values
...
class ContractTypeFeatureExtractor(BaseEstimator):
    def __init__(self, na_string = "nan", na_class = 'miss', feature_name='ContractType'):
